...
public class Test {
    ...
    public static void main(String[] args) throws ParseException {
    	try (FileSystemXmlApplicationContext ctx = new FileSystemXmlApplicationContext("D:\\Skola\\SP1\\App\\Server\\src\\main\\webapp\\WEB-INF\\dispatcher-servlet.xml")) {
	        testInternal(ctx);
    	}
    }

	private static void testInternal(FileSystemXmlApplicationContext ctx) throws ParseException {
